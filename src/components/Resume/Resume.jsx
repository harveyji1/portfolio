    ...
    <div id="resume">
      ...
      <Accordion defaultActiveKey="0">
        <Accordion.Item eventKey="0">
          <Accordion.Header onClick={() => setEducationOpen(!educationOpen)}>
            Education
            <span
              className={`chevron-icon ${
                educationOpen ? "rotate-icon" : ""
              }`}
            >
              <FaChevronDown />
            </span>
          ...
          <Accordion.Body className="educationBody">
            <div className="universityInfo">
              <Card className="resume-card">
                <Card.Header>August 2024 - May 2024</Card.Header>
                <Card.Body>
                  <Card.Title>University of Kansas</Card.Title>
                  <Card.Text>Bachelors of Science</Card.Text>
                </Card.Body>
              </Card>
            </div>
            <div className="majorInfo">
              ...
              <Card className="resume-card">
                <Card.Body>
                  ...
                  <Card.Text>School of Business</Card.Text>
                </Card.Body>
                <ListGroup className="list-group-flush">
                  <ListGroup.Item>4.0 School GPA</ListGroup.Item>
                </ListGroup>
        ...
        <Accordion.Item eventKey="1">
          <Accordion.Header onClick={() => setWorkOpen(!workOpen)}>
            Work Experience
            <span
              className={`chevron-icon ${workOpen ? "rotate-icon" : ""}`}
            >
              <FaChevronDown />
            </span>
          </Accordion.Header>
          <Accordion.Body>
            ...
            <Card className="resume-card">
              ...
              <Card.Body>
                ...
                <Card.Text>Kansas City National Security Campus</Card.Text>
              </Card.Body>
              <ListGroup className="list-group-flush">
            ...
            <Card className="resume-card">
              ...
              <Card.Body>
                ...
                <Card.Text>UltraSource LLC</Card.Text>
              </Card.Body>
              <ListGroup className="list-group-flush">
        ...
        <Accordion.Item eventKey="3">
          ...
          <Accordion.Body>
            <Card className="resume-card">
              <Card.Header>January 2023 - December 2023</Card.Header>
              <Card.Body>
                <Card.Title>Director of Recruitment</Card.Title>
                <Card.Text>Interfraternity Council</Card.Text>
              </Card.Body>
              <ListGroup className="list-group-flush">
                <ListGroup.Item>
            ...
            <Card className="resume-card">
              ...
              <Card.Body>
                ...
                <Card.Text>University of Kansas</Card.Text>
              </Card.Body>
              <ListGroup className="list-group-flush">
            ...
            <Card className="resume-card">
              ...
              <Card.Body>
                ...
                <Card.Text>Alpha Tau Omega Fraternity</Card.Text>
              </Card.Body>
              <ListGroup className="list-group-flush">
                <ListGroup.Item>
                  Conducted recruitment events and votings
                </ListGroup.Item>
                <ListGroup.Item>
                  Oversaw weekly chapter meetings
                </ListGroup.Item>
              </ListGroup>
            </Card>
          </Accordion.Body>
